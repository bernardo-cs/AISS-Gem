...
public class CryptoManagement {
	...
	public static String getNonce(){
		...
		return "Mail enviado por: " + userName + " na data: " + dateFormat.format(cal.getTime());
		
	}

	public static PublicKey getPubKeyFromCC() throws PteidException{
		try {
	...
	public static String getCypheredNonceFromCC(String nonce) throws ClassNotFoundException, SecurityException, NoSuchMethodException, IllegalArgumentException, IllegalAccessException, InvocationTargetException, PKCS11Exception{
		/**
		 * get Pkcs11 session
		 */
		PKCS11 pkcs11 = null;
		...
		return new String(signed_nonce);
	}
